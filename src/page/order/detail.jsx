                ...
                <div className="form-horizontal">
                    <div className="form-group">
                        <div className="col-md-2">
                            <label className="control-label">订单号</label>
                        </div>
                    ...
                    <div className="form-group">
                        <div className="col-md-2">
                            <label className="control-label">收件人</label>
                        </div>
                        <div className="col-md-5">
                    ...
                    <div className="form-group">
                        <div className="col-md-2">
                            <label className="control-label">订单金额</label>
                        </div>
                        <div className="col-md-5">
                            <p className="form-control-static">
                    ...
                    <div className="form-group">
                        <div className="col-md-2">
                            <label className="control-label">商品列表</label>
                        </div>
